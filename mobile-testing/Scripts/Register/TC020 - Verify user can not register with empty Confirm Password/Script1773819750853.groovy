...
Mobile.waitForElementPresent(
	findTestObject('Object Repository/Page_Register/msg_ConfirmPasswordRequired'),
	10
)

Mobile.verifyElementExist(findTestObject('Object Repository/Page_Register/msg_ConfirmPasswordRequired'), 5)
