...
Mobile.waitForElementPresent(
	findTestObject('Object Repository/Page_Register/msg_InvalidEmailFormat'),
	10
)

Mobile.verifyElementExist(findTestObject('Object Repository/Page_Register/msg_InvalidEmailFormat'), 5)