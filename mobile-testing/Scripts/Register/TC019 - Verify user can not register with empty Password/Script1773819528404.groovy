...
Mobile.waitForElementPresent(
	findTestObject('Object Repository/Page_Register/msg_PasswordRequired'),
	10
)


Mobile.verifyElementExist(findTestObject('Object Repository/Page_Register/msg_PasswordRequired'), 5)
